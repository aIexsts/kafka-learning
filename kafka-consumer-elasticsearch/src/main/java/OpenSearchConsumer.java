...
//        String connString = "https://c9p5mwld41:45zeygn9hy@kafka-course-2322630105.eu-west-1.bonsaisearch.net:443";
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (openSearchClient; kafkaConsumer) { // auto close after try finished!! :D

            createIndexIfNotExist( "wikimedia", log, openSearchClient);

            // we subscribe the consumer to topic
...
//                    String id = record.topic() + "_" + record.partition() + "_" + record.offset();
                    ...
                    try {
                        ...
                        IndexRequest indexRequest = new IndexRequest("wikimedia")
                            ...
                            .id(id); // idempotent - same id item will be overridden
...
//                        log.info(response.getId());
    ...
    private static void createIndexIfNotExist(
